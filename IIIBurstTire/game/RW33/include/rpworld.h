 ...
 * Automatically Generated on: Wed Apr 03 17:40:16 2002
 *
 ************************************************************************/
...
#define RpMaterialAddRefVoid(_material)                             \
    RpMaterialAddRefVoidMacro(_material)
...
#define RpMaterialSetSurfacePropertiesVoid(_material, _surfProps)   \
    RpMaterialSetSurfacePropertiesVoidMacro(_material, _surfProps)
...
extern void RpMaterialAddRefVoid(RpMaterial *material);
...
extern void 
RpMaterialSetSurfacePropertiesVoid(RpMaterial *material,
                                   const RwSurfaceProperties *surfaceProperties);
...
#define RpClumpSetFrameVoid(_clump, _frame) \
    RpClumpSetFrameVoidMacro(_clump, _frame)
...
extern void
RpClumpSetFrameVoid(RpClump * clump,
                    RwFrame * frame);
