 ...
 * Automatically Generated on: Wed Apr 03 17:40:15 2002
 *
 ************************************************************************/
...
#define RwTextureAddRefVoid(_tex)                           \
    RwTextureAddRefVoidMacro(_tex)
...
extern void       RwTextureAddRefVoid(RwTexture *texture);
...
#define RwCameraSetRasterVoid(_camera, _raster)                 \
    RwCameraSetRasterVoidMacro(_camera, _raster)
...
#define RwCameraSetZRasterVoid(_camera, _raster)                \
    RwCameraSetZRasterVoidMacro(_camera, _raster)
...
#define RwCameraSetFrameVoid(_camera, _frame)                   \
    RwCameraSetFrameVoidMacro(_camera, _frame)
...
extern void         RwCameraSetRasterVoid(RwCamera *camera, RwRaster *raster);
...
extern void         RwCameraSetZRasterVoid(RwCamera *camera, RwRaster *zRaster);
...
extern void         RwCameraSetFrameVoid(RwCamera *camera, RwFrame *frame);
